...
Written 2026-09-11 14:20 EDT on the Alienware box (`chuye-Alienware-Aurora-R11`).
...
| **MoF-MoE run (the actual method)** | 🟡 **epoch 281/500**, running since 2026-09-10 08:25, ETA Sat 2026-09-12 ≈ 13:30 |
| MoF-MoE evaluation + videos | ⏳ armed (`notes/scripts/chain3_after_mof_moe.sh`), blocked by the driver issue below |
